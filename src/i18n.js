...
const EN = {
  ...
  'form.sourceOfTruthPlaceholder': 'Paste one definitive resolution source URL, if you have one',
  ...
  'gate.sourceNoSourcesText': 'No machine-readable URLs were found in the source of truth, draft, resolution section, references, or source claims. Add explicit source URLs to the resolution rules before finalizing.',
...
const ZH = {
  ...
  'form.sourceOfTruth': '事实来源',
  'form.sourceOfTruthPlaceholder': '如有,粘贴一个权威决议来源 URL',
  ...
  'gate.sourceNoSourcesText': '在事实来源、草稿、决议章节、参考资料或来源陈述中均未发现机器可读的 URL。请在定稿前在决议规则中加入明确的来源 URL。',
