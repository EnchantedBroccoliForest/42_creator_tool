...
const EN = {
  ...
  "timeline.ariaLabel": "Post-draft progress",
  "timeline.reviewDeliberate": "Review & Deliberate",
  ...
  "form.questionPlaceholder":
    "e.g., Which artist tops the Billboard Hot 100 year-end chart 2026?",
  ...
  "form.outcomeNameAria": "Outcome {n} name",
  "form.outcomeRemoveAria": "Remove outcome {n}",
  "form.addOutcome": "Add outcome",
  ...
  "toolbar.skipUpdate": "Skip Update → Finalize",
  "toolbar.skipUpdateTitle":
    "Keep this draft as-is and run only the risk + source-accessibility gates before finalizing. Safe when reviewer feedback is minor and you accept the draft as written; HIGH risk or unreachable sources will still gate Finalize.",
  "toolbar.checkingGates": "Checking gates...",
  "toolbar.acceptFinalize": "Accept & Finalize",
  "toolbar.finalizing": "Finalizing...",
  "toolbar.acceptTitleConfigChanged":
    "Rerun review with the selected council and update the draft before finalizing.",
  "toolbar.acceptTitleNeedsRiskAck":
    "Acknowledge the HIGH early-resolution risk below before finalizing.",
  "toolbar.acceptTitleNeedsRoutingAck":
    "Resolve or acknowledge the blocking claims flagged by the rigor pipeline before finalizing.",
  "toolbar.acceptTitleNeedsSourceAck":
  ...
  "gate.low": "LOW",
  "gate.earlyWarning":
    "This market may resolve before its end date. Acknowledge the risk to unlock Finalize, or revise the draft (e.g. add an explicit early-resolution clause, shorten the window, or tighten the outcome set).",
  ...
  "gate.routingWarning":
    "The draft is blocked because one or more claims have serious issues. Re-run Review → Update to fix them, or acknowledge to finalize anyway.",
  ...
  "gate.sourceHint":
    "Probes each data source in the resolution rule to confirm the oracle will actually be able to read it at settlement time. Unreachable sources risk a market that cannot resolve — fix them before finalizing.",
  "gate.sourceNoSourcesText":
    "No machine-readable URLs were found in the draft, its resolution section, references, or source claims. Add explicit source URLs to the resolution rules before finalizing.",
  "gate.sourceErrorText":
    "Accessibility check failed: {error}. This does not block Finalize, but you should verify the sources manually.",
  "gate.sourceUnreachableHeading": "Unreachable ({n}):",
  "gate.sourceReachableHeading": "Reachable ({n}):",
  "gate.sourceWarningAll":
  ...
  "routingReason.verificationSoft":
    "Flagged as a potential issue during verification",
  ...
  "final.dashboardDescription": "Dashboard description",
  "final.outcomes": "Outcomes ({n})",
  "final.winsIf": "Wins if:",
  "final.resolvedBy": "Resolved by:",
  "final.verify": "Verify:",
  "final.seeResolution": "See resolution criteria.",
  ...
  "final.showFullSpec": "More details (outcomes, rules, edge cases)",
  "final.moreInFullSpec": "+{n} more in full spec",
  "final.previewLabel": "Preview — for understanding only",
  "final.previewHint":
    "The dashboard-ready resolution description is below. Paste that into 42.space.",
  "final.scrollToOutput": "Scroll down for the final dashboard output",
  "final.dashboardOutputBadge": "Final output",
  ...
  "log.claimExtractionCrashed":
    "Background claim extraction crashed: {message}",
...
const ZH = {
  ...
  "form.outcomeNameAria": "结果 {n} 名称",
  "form.outcomeRemoveAria": "移除结果 {n}",
  "form.addOutcome": "添加结果",
  ...
  "toolbar.reviewAlreadyCurrent":
    "此审阅已反映当前选定的小组。请更新草稿或更改小组以再次审阅。",
  "toolbar.updateDraft": "更新草稿",
  "toolbar.updating": "更新中……",
  "toolbar.skipUpdate": "跳过更新 → 定稿",
  "toolbar.skipUpdateTitle":
    "保留当前草稿,只运行风险与数据源可达性检查后即可定稿。仅当审阅反馈较轻、且你接受当前草稿时使用;高风险或源不可达仍会拦截定稿。",
  "toolbar.checkingGates": "检查中……",
  "toolbar.acceptFinalize": "接受并定稿",
  "toolbar.finalizing": "定稿中……",
  "toolbar.acceptTitleConfigChanged":
    "请在定稿前用所选小组重新审阅并更新草稿。",
  "toolbar.acceptTitleNeedsRiskAck":
    "请先确认下方的「高」提前结算风险后再定稿。",
  "toolbar.acceptTitleNeedsRoutingAck":
    "请在定稿前解决或确认严谨流水线标记出的阻断性陈述。",
  "toolbar.acceptTitleNeedsSourceAck":
    "决议规则中有一个或多个数据源无法访问。请修复数据源并重新运行更新,或确认后强制定稿。",
  ...
  "gate.low": "低",
  "gate.earlyWarning":
    "此市场可能在结束日期之前就已结算。请确认风险以解锁「定稿」,或修改草稿(例如:加入明确的提前结算条款、缩短窗口、或收紧结果集)。",
  ...
  "gate.routingHint":
    "这些检查会验证草稿中的陈述 — 决议来源、规则、边缘情况 — 是否一致且有充分依据。",
  ...
  "gate.routingWarning":
    "草稿被阻断,因为有一个或多个陈述存在严重问题。请重新运行「审阅 → 更新」修复它们,或确认后强制定稿。",
  ...
  "gate.sourceHint":
    "探测决议规则中的每个数据源,以确认结算时神谕能够实际读取它。无法访问的数据源会让市场存在无法结算的风险 — 请在定稿前修复。",
  "gate.sourceNoSourcesText":
    "在草稿、决议章节、参考资料或来源陈述中均未发现机器可读的 URL。请在定稿前在决议规则中加入明确的来源 URL。",
  "gate.sourceErrorText":
    "可访问性检查失败:{error}。这不会阻止「定稿」,但你应当手动核实数据源。",
  "gate.sourceUnreachableHeading": "不可访问({n}):",
  "gate.sourceReachableHeading": "可访问({n}):",
  "gate.sourceWarningAll":
    "所有引用的数据源都无法在浏览器中解析。神谕无法读取它无法访问的来源 — 请在定稿前用可用的 URL 修改草稿,或确认后强制定稿。",
  "gate.sourceWarningSome":
  ...
  "final.dashboardDescription": "看板描述",
  "final.outcomes": "结果({n})",
  "final.winsIf": "获胜条件:",
  "final.resolvedBy": "决议依据:",
  "final.verify": "核对:",
  "final.seeResolution": "见决议标准。",
  "final.settlement": "结算",
  ...
  "final.showFullSpec": "更多详情(结果、规则、边界情况)",
  "final.previewLabel": "预览 — 仅供理解",
  "final.previewHint": "下方为面板可粘贴的解析描述。将其粘贴到 42.space。",
  "final.scrollToOutput": "向下滚动查看最终面板输出",
  "final.dashboardOutputBadge": "最终输出",
